...
const update_beer_repository_1 = require("./update-beer-repository");
const fakeBeer = {
...
const makeSut = () => {
    return new update_beer_repository_1.UpdateBeerMongoRepository();
};
...
//# sourceMappingURL=update-beer-repository.spec.js.map